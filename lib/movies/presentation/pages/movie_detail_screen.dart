...
import 'package:netflixapp/movies/presentation/controller/movie_details_bloc.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => sl<MovieDetailsBloc>()..add(GetMovieDetails(id))..add(GetMovieRecommendations(id)),
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstances.imageUrl(state.movieDetail!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
